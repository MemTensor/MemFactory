...
│   ├── memory_update.py       # 记忆更新决策模块
│   ├── memory_organization.py # 记忆组织构建模块
│   ├── memory_search.py       # 记忆检索模块
│   └── common.py             # 公共配置和工具
├── RL/                     # 强化学习训练模块
│   ├── mem_grpo_trainer.py   # GRPO训练器
│   ├── train_grpo.py         # 训练脚本
│   ├── reward.py            # 奖励函数
│   └── mem_utils.py         # 训练工具
├── example/                # 使用示例
│   ├── memory_pipeline_demo.ipynb    # 完整Pipeline演示
│   ├── ch10_memory_extraction_01.ipynb  
│   ├── ch11_memory_organization_01.ipynb 
│   └── ch13_memory_update_01.ipynb      
├── scripts/                # 实用工具脚本
